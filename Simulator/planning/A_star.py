...
def get_next_node(v, map):
    ...
    if f == 0:
        ways =  [1, 0, 0], [1, -1, 1], [1, 1, 7], [0, 0, 1], [0, 0, 7]
    elif f == 1:
        ways =  [1, -1, 1], [1, 0, 0], [0, -1, 2], [0, 0, 0],[0, 0, 2]
    elif f == 2:
        ways =  [0, -1, 2], [1, -1, 1], [-1, -1, 3], [0, 0, 1], [0, 0, 3]
    elif f == 3:
        ways =  [-1, -1, 3], [-1, 0, 4], [0, -1, 2], [0, 0, 4],[0, 0, 2]
    elif f == 4:
        ways =  [-1, 0, 4], [-1, -1, 3], [-1, 1, 5], [0, 0, 3], [0, 0, 5]
    elif f == 5:
        ways =  [-1, 1, 5], [-1, 0, 4], [0, 1, 6], [0, 0, 4], [0, 0, 6]
    elif f == 6:
        ways =  [0, 1, 6], [-1, 1, 5], [1, 1, 7], [0, 0, 5], [0, 0, 7]
    elif f == 7:
        ways =  [1, 1, 7], [0, 1, 6], [1, 0, 0], [0, 0, 6], [0, 0, 0]
